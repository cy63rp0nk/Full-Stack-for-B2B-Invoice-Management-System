...
public class Response {
	...
	public String toString() {
		return "Response [serial=" + sl_no + ", Business code=" + business_code + ", Customer number=" + cust_number
				+ ", Clear date=" + clear_date + ", Business year=" + buisness_year
				+ ", Document id=" + doc_id + ", Posting date=" + posting_date + ", Document create date="
				+ document_create_date + ", Document create date 1=" + document_create_date1 + ", Due date=" + due_in_date 
				+ ", Invoice currency=" + invoice_currency + ", Document type=" + document_type + ", Posting ID=" + posting_id 
				+ ", Area of business=" + area_business + ", Total open amount=" + total_open_amount +", Baseline create date=" 
				+ baseline_create_date + ", Customer paymrnt terms=" + cust_payment_terms+", Invoice ID=" + invoice_id 
	...
	public void setBuisness_year(String business_year) {
